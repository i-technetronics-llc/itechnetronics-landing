...
<Box mb='10' mt='16'>
    ...
    <Card w='80%' m="auto" h='400px' bgColor='black' p='0' border='3px solid black' borderRadius='20px' color='white'>
        <CardBody w='100%' >
            ...
            <Text  maxWidth={'260px'} fontSize='14px' mt='2'>Our flagship product designed to shape the future with innovative technology solutions by empowering businesses and individuals with user-friendly, affordable, and accessible software.</Text>
        </CardBody>
    ...
    <Card w='80%' bgColor='black' h='400px'  m="auto"  p='0' border='3px solid black' borderRadius='20px' color='white'>
        <CardBody w='100%' >
            ...
            <Text  maxWidth={'260px'} fontSize='14px' mt='2'>A developer-centric feature flag service with unlimited team size, awesome support, and a reasonable price tag.</Text>
        </CardBody>
    ...
    <Card w='80%' bgColor='black' h='400px' p='0'  m="auto"  border='3px solid black' borderRadius='20px' color='white'>
        <CardBody w='100%' >
            ...
            <Text  maxWidth={'260px'} fontSize='14px' mt='2'>(Adashe/Ajo/Esusu); Revolutionizing financial management with our suite of digital solutions.</Text>
        </CardBody>
    ...
    <Card w='80%' bgColor='black' h='400px' p='0'  m="auto"  border='3px solid black' borderRadius='20px' color='white'>
        <CardBody w='100%' >
            ...
            <Text  maxWidth={'260px'} fontSize='14px' mt='2'>Empowering businesses and individuals with cross-board finance solutions, making financial management simpler and more efficient.</Text>
        </CardBody>
    ...
    <Card w='80%' bgColor='black' h='400px'  m="auto"  p='0' borderColor='3px solid black' borderRadius='20px' color='white'>
        <CardBody w='100%' >
            ...
            <Text className={styles.heading} fontSize='2xl' fontWeight='bold' ml='8' mt='-10'>AntFi</Text>
            <Text  fontSize='14px' maxWidth={'260px'} mt='2'>Empowering businesses and individuals with cross-board finance solutions, making financial management simpler and more efficient.</Text>
        </CardBody>
