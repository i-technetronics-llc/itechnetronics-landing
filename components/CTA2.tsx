          ...
          <Card bgColor={"rgb(18,17,36)"}>
            ...
            <CardBody>
              <Text
                ...
                lineHeight="39px"
              >
                We are a dynamic force dedicated to developing cutting-edge
                hardware and software solutions with a strong focus on people.
              </Text>
            </CardBody>
          </Card>
          <Card bgColor={"rgb(18,17,36)"}>
            ...
            <CardBody>
              <Text
                ...
                lineHeight="39px"
              >
                We create solutions that are friendly, easy to use, affordable,
                and accessible, ensuring we serve the underserved.
              </Text>
            </CardBody>
          </Card>
          <Card bgColor={"rgb(18,17,36)"} borderRadius="5px">
            ...
            <CardBody>
              <Text
                ...
                lineHeight="39px"
              >
                We are driven by a fellowship of product managers and teams who
                brainstorm and curate ideas to solve real-world problems.{" "}
              </Text>
            </CardBody>
          </Card>
        </SimpleGrid>
