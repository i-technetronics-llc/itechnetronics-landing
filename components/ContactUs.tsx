...
function JoinJourney() {
  return (
    ...
    >
      {" "}
      <Text fontSize={"4xl"} display={{base:'none', md:"block"}} color={"#fff"} mb="4" className={styles.heading}>
        Reach out to us!
      </Text>
      <Box
        display={"flex"}
        ...
        alignItems={"center"}
      >
         <Text fontSize={"4xl"} color={"#fff"} mb="4" display={{base:'block', md:"none"}} className={styles.heading}>
        Reach out to us!
      </Text>
      <Box
        display={"flex"}
      ...
      >
        ...
        <Box>
          <Text
            ...
            maxWidth={"600px"}
          >
            Join us on our journey, explore our products, and be a part of the
            innovation-driven, people-centric revolution in technology.
            Together, we can build a brighter, more accessible, and equitable
            future for all.
          </Text>
        ...
        >
            ...
            <CardHeader>
              ...
              >
                <Text
                  ...
                  height="10px"
                  borderRadius={"100%"}
                  bgColor="rgba(27, 7, 255, 1)"
                ></Text>
                <Text fontSize={{ base: "20px", md: "16px" }}>United</Text>
              </Box>
            </CardHeader>
            <CardBody>
              <Text color={"white"} fontSize={{ base: "18px", md: "18px" }}>
                8 The Green Suite R{" "}
              </Text>
              <Text color={"white"} fontSize={{ base: "18px", md: "18px" }}>
                Dover, DE 19901
          ...
          <Card bgColor={"rgb(18,17,36)"} borderRadius="5px">
            ...
            <CardBody>
              ...
              <Text color={"white"} fontSize={{ base: "18px" }}>
